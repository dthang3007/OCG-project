          ...
          <div class="col-lg-3 col-md-3">
            <ul class="nav nav-tabs" role="tablist">
              ...
              >
                ...
                >
                  <img :src="image.src" alt="..." class="product__pic__item" />
                </a>
              </li>
            </ul>
          </div>
          ...
          <div class="col-lg-8">
            <div class="product__details__text">
              ...
              <div class="product__details__cart__option">
                ...
                <a href="#" class="primary-btn" @click="addProductToCart">add to cart</a>
              </div>
              ...
              <div class="product__details__last__option">
                ...
                <ul>
                  ...
                  <li><span>Categories:</span> {{ product.category_id }}</li>
                  <li><span>Trade mark</span> {{ product.trade_mark }}</li>
                  <li><span>Model</span> {{ product.version }}</li>
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
          <div class="product__item">
            ...
            <div class="product__item__text">
              <h6>Piqué Biker Jacket</h6>
              <a href="#" class="add-cart" @click="addProductToCart">+ Add To Cart</a>
              <div class="rating">
                <i class="fa fa-star-o"></i>
                <i class="fa fa-star-o"></i>
                <i class="fa fa-star-o"></i>
...
export default {
  ...
  async created() {
    ...
    this.show = response.data.images[0].src;
